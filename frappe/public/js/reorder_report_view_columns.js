...
//     if (["Sales Invoice", "Quotation", "Journal Entry"].includes(this.doctype)) {
//         this.columns = reorder_reportview_fields(this.doctype, this.columns);
//     }
// };

function reorder_reportview_fields(doctype, columns) {
