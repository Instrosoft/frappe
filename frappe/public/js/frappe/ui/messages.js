...
frappe.confirm = function (message, confirm_action, reject_action, confirm_action_label,reject_action_label) {
	var d = new frappe.ui.Dialog({
		title: __("Confirm", null, "Title of confirmation dialog"),
		primary_action_label: __(confirm_action_label || "Yes", null, "Approve confirmation dialog"),
		primary_action: () => {
			confirm_action && confirm_action();
			d.hide();
		},
		secondary_action_label: __(reject_action_label || "No", null, "Dismiss confirmation dialog"),
